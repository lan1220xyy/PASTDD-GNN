...
class Trainer(object):
    ...
    def train(self):
        self.logger.info(f'begin to train! args:{self.args}')
        best_model = None
        best_loss = float('inf')
        ...
        for epoch in range(1, self.args.epochs + 1):
            ...
            print(f'training time: {time.time()-train_epoch_time}')
            ...
            print(f'valid time: {time.time()-val_epoch_time}')
    ...
    def test(model, args, data_loader, scaler, logger, path=None):
        ...
        np.save('{}/{}_true.npy'.format(args.log_dir,args.dataset), y_true.cpu().numpy())
        np.save('{}/{}_pred.npy'.format(args.log_dir,args.dataset), y_pred.cpu().numpy())
