...
#get configuration
config_file = '{}/config_file/{}_{}.conf'.format(root_dir, DATASET, MODEL)
#print('Read configuration file: %s' % (config_file))
config = configparser.ConfigParser()
config.read(config_file)

from lib.metrics import MAE_torch,MAPE_torch
...
args.add_argument('--embed_d_model', default=config['model']['embed_d_model'], type=int)
...
args.add_argument('--lamb', default=config['model']['lamb'], type=float)
...
model = Network(args,period,unique_periods)
...
log_dir = os.path.join(root_dir,'experiments', args.dataset, FLOW, MODEL,current_time)
